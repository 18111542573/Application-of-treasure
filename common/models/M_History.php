...
class M_History extends MY_Model {
    ...
    public function getHistoryNew($app_id, $order_by = "history_id desc",$type = '1',$field = "*")
    {
        if ($app_id < 1) {
            return false;
        }
    ...
    public function getHistoryNew2($app_id, $order_by = "history_id desc" ,$field = "*")
    {
        if ($app_id < 1) {
            return false;
        }
        ...
        return $this->getAll($this->_table, $where, $order_by,$field);
    }

    public function getIOSHistoryNew($app_id, $order_by = "history_id desc",$field = "*")
    {
        if ($app_id < 1) {
            return false;
        }
