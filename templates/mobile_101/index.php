...
<div class="header">
    <a href="/"><img src="<!--{imageurl url=$setting.wap_logo}-->" alt="<!--{$setting.site_name}-->" height="55"/></a>
</div>
        ...
        <div class="bd">
            <div class="tempWrap">
                <ul>
                    <!--{ad id=32}-->
                    <li>
                        <a href="<!--{$ad.link}-->"><img src="<!--{imageurl url=$ad.image}-->" alt="<!--{$ad.alt}-->"></a>
                    </li>
                    <!--{/ad}-->
                </ul>
            </div>
    ...
    <ul class="spe none3">
        ...
        <li>
            <a href="<!--{link m='special' special_id=$list.area_id}-->" title="">
                <div class='spe-img'>
                    <img src="<!--{imageurl url=$list.area_logo}-->" alt="<!--{$list.area_title}-->"/>
                </div>
