...
<div class="gamed model">
    ...
    <div class="gamed-app">
        ...
        <div class="gamed-app-qr right">
            <div class="left">
                <p class="clear"><a class="mt5 btn btn-style8 btn-xl " href="<!--{link m='download' app_id=$app.app_id type=1 }-->">安卓下载</a></p>
                <p class="clear"><a class="mt5 btn btn-style8 btn-style08 btn-x2" href="<!--{link m='download' app_id=$app.app_id type=2 }-->" target="_blank">苹果下载</a></p>
            </div>
