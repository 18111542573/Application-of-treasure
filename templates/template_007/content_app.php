            ...
            <div class="grid">
                <div class="col9 first">
                    <div class="mod-soft-info clearfix" data-desc="detailinfo">
                        ...
                        <div class="options">
                            <a class="btn-1 setup" href="<!--{link m='download' app_id=$app.app_id type=1 }-->">点击下载</a>
                            <a class="btn-1 setup h-down" href="<!--{link m='download' app_id=$app.app_id type=2 }-->">高速下载</a>
