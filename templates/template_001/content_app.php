                        ...
                        <!--{else}-->
                            ...
                            <div style="margin-top:10px;">
                                <form action="/api.php?c=ajax&m=comment&app_id=<!--{$app.app_id}-->" method="post" id="commentForm">
                                    ...
                                    <span class="comment_l">
                                        <img onclick="this.src='<!--{imageurl url='api.php?c=index&m=xcode&t='}-->'+Math.random();" style="width:60px;height:25px;margin:-4px 8px 0 6px;vertical-align: bottom;" src="<!--{imageurl url='api.php?c=index&m=xcode'}-->" id="chk_code" title="点击更换验证码">
                                    </span>
                                    <span class="comment_l">
