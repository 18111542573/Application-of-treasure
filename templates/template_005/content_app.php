                        ...
                        <div class="apk_info_box">
                            ...
                            <div class="dl_area">
                                <div class="btn_trig">
                                    ...
                                    <a href="<!--{link m='download' app_id=$app.app_id type=1 }-->" class="btn btn_dl"
                                       id="quickDown" title="<!--{$app.app_title}-->下载"
                                       rel="nofollow">安卓下载</a>
                                    <a href="<!--{link m='download' app_id=$app.app_id type=2 }-->" class="mt12 ly-btn2" rel="nofollow">苹果下载安卓下载</a>
                                </div>
                                <div class="ewm">
