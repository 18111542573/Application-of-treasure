<?php /* Smarty version 3.1.27, created on 2018-03-22 06:59:11
         compiled from "E:\www\711cms\templates\template_006\list_game.php" */ ?>
<?php
/*%%SmartyHeaderCode:8109213545ab3543fe9b578_59140086%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1cbc1bdd28d021914f056affe6f9a8807172e17f' => 
    array (
      0 => 'E:\\www\\711cms\\templates\\template_006\\list_game.php',
      1 => 1500951331,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8109213545ab3543fe9b578_59140086',
  'variables' => 
  array (
    'cate_id' => 0,
    'row' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5ab3543ff08b81_19125585',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5ab3543ff08b81_19125585')) {
function content_5ab3543ff08b81_19125585 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '8109213545ab3543fe9b578_59140086';
?>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_row(array('name'=>'recommend','id'=>29), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <div class="tab_con">
            <ul class="list_tj" id="li_scroll" style="margin-left: -952px;">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>29,'row'=>16)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>29,'row'=>16), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" target="_blank" ><?php echo $_smarty_tpl->tpl_vars['recommend']->value['app_title'];?>
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>29,'row'=>16), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
"><?php echo $_smarty_tpl->tpl_vars['keyword']->value['q'];?>
    ...
    <div class="b_main fr">
        <div class="sub_tit">
            <div class="order">
                <a <?php if ($_smarty_tpl->tpl_vars['order']->value == 0) {?> class="order_on" <?php }?> href="<?php echo smarty_function_link(array('m'=>'games','cate_id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'page'=>$_smarty_tpl->tpl_vars['page']->value),$_smarty_tpl);?>
">更新时间<s></s></a>
                <a <?php if ($_smarty_tpl->tpl_vars['order']->value == 1) {?> class="order_on" <?php }?> href="<?php echo smarty_function_link(array('m'=>'games','cate_id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'order'=>1,'page'=>$_smarty_tpl->tpl_vars['page']->value),$_smarty_tpl);?>
">下载次数<s></s></a>
            </div>
            全部软件
        </div>
        <ul class="app_list">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('applist', array('page'=>$_smarty_tpl->tpl_vars['page']->value,'order'=>$_smarty_tpl->tpl_vars['order_by']->value,'parent'=>2,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'per_page'=>18)); $_block_repeat=true; echo smarty_block_applist(array('page'=>$_smarty_tpl->tpl_vars['page']->value,'order'=>$_smarty_tpl->tpl_vars['order_by']->value,'parent'=>2,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'per_page'=>18), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
人在用</p>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_applist(array('page'=>$_smarty_tpl->tpl_vars['page']->value,'order'=>$_smarty_tpl->tpl_vars['order_by']->value,'parent'=>2,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'per_page'=>18), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                  
        </ul>
        <?php echo smarty_function_pagebar(array('name'=>'applist','page'=>$_smarty_tpl->tpl_vars['page']->value,'parent'=>2,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'order'=>$_smarty_tpl->tpl_vars['order']->value,'per_page'=>18),$_smarty_tpl);?>
