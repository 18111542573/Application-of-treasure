<?php /* Smarty version 3.1.27, created on 2018-03-20 11:47:10
         compiled from "E:\www\711cms\templates\template_003\list_soft.php" */ ?>
<?php
/*%%SmartyHeaderCode:229745ab0843ede4c04_33339359%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b687073b3c086ce776a72c22d4a36a74ed1bb53' => 
    array (
      0 => 'E:\\www\\711cms\\templates\\template_003\\list_soft.php',
      1 => 1500953873,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '229745ab0843ede4c04_33339359',
  'variables' => 
  array (
    'cate_id' => 0,
    'row' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5ab0843ee7d1b0_14378153',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5ab0843ee7d1b0_14378153')) {
function content_5ab0843ee7d1b0_14378153 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '229745ab0843ede4c04_33339359';
?>
...
<div class="model">
    ...
    <div class="game-s">
        <ul class="game-tab-subnav" id="gameTabSubNav1">
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('recommend', array('id'=>41,'row'=>16)); $_block_repeat=true; echo smarty_block_recommend(array('id'=>41,'row'=>16), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"><?php echo mb_substr($_smarty_tpl->tpl_vars['recommend']->value['app_title'],0,8,'utf-8');?>
            ...
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_recommend(array('id'=>41,'row'=>16), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <div class="game-list-page">
            ...
            <div class="sub-nav">
                ...
                <p>
...
} else { ?>class="on"<?php }?> href="<?php echo smarty_function_link(array('m'=>'softs'),$_smarty_tpl);?>
                    ...
                    <a <?php if ($_smarty_tpl->tpl_vars['cate_id']->value == $_smarty_tpl->tpl_vars['appnav']->value['cate_id']) {?>class="on"<?php }?> href="
                    <?php echo smarty_function_link(array('m'=>'softs','cate_id'=>$_smarty_tpl->tpl_vars['appnav']->value['cate_id']),$_smarty_tpl);?>
">
        ...
        <div class="game-tab-sublist clear" id="gameTabSubList1">
            ...
            <ul class="game-tab-subcon current ">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('applist', array('parent'=>1,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>16)); $_block_repeat=true; echo smarty_block_applist(array('parent'=>1,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>16), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
                        ...
                        <div class="game-tab-subcon-detail clear">
                            ...
                            <p><span class="font-gray">软件大小：</span><span class="font-orange"><?php echo round($_smarty_tpl->tpl_vars['applist']->value['history_size']/1024/1024,2);?>
MB</span>
                            </p>

                            <p><span class="font-gray">软件类型：</span><?php echo $_smarty_tpl->tpl_vars['applist']->value['cname'];?>
</p>
...
" target="_blank">软件下载</a>
                ...
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_applist(array('parent'=>1,'id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>16), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

            </ul>

            <?php echo smarty_function_pagebar(array('name'=>'applist','id'=>$_smarty_tpl->tpl_vars['cate_id']->value,'parent'=>1,'page'=>$_smarty_tpl->tpl_vars['page']->value,'per_page'=>16),$_smarty_tpl);?>
