...
<!--                        <a class="cur" id="upload_apk"><strong>上传手助</strong></a>-->
<!--                        --><?php //if($site_apk):?>
...
<script type="application/javascript">
    $(function () {
        ...
        $("#upload_apk").ajaxUploadPrompt({
            url: '<?=build_url("Index", "uploadSiteApk", array('time' => $time, 'token' => $token))?>',
            data: ":file",
            success: function (data, status, xhr) {
                ...
                if ($('#site_apk').length > 0) {
                    ...
                    $('#upload_apk').after('<a class="cur" id="site_apk" href="' + data[0] + '"><strong>手机助手下载地址</strong></a>');
                }
            }
        })
    })
